 ...
 *
 * To start this game, the project asks how many players are going to play and each one’s name.
 * Each player will be given 5 dice.
 * Then in each round, each player rolls five dice and keeps the result secret from other players.
 *
 * They then take turns bidding on the total results.
 ...
 * Players take turns to make the bid.
 *
 * Each player has two choices during his/her turn: to make a higher bid, or to challenge the previous bid – call the previous player “liar”.
